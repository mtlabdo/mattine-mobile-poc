package com.mattine.mattinepoc.datasource.network.utils

const val UNKNOWN_STATUS_CODE = 0
...
fun Int?.toHttpStatus(): StatusCode {
    return when (this) {
        ...
        UNKNOWN_STATUS_CODE -> StatusCode.Unknown
